...
from ultralytics.nn.modules import (AIFI, C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x,
                                    ...
                                    CoordAtt, CloFormer, ODConv_3rd, ConvNextBlock, HighPerfGAM, C2f_HighPerfGAM, C2f_HighPerfGAM_NoGlobal, C2f_HighPerfGAM_NoChannel, C2f_HighPerfGAM_NoLocal, ECAPlusPlus, ECAPlusPlus_MS, ECAPlusPlus_MS_TS, ECAPlusPlus_MS_TS_SC, C2f_Attention, Bottleneck_Attention, SimAM)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 CoordAtt, ECA_Attention, CloFormer, ODConv_3rd, ConvNextBlock, HighPerfGAM, C2f_HighPerfGAM, C2f_HighPerfGAM_NoGlobal, C2f_HighPerfGAM_NoChannel, C2f_HighPerfGAM_NoLocal, ECAPlusPlus, ECAPlusPlus_MS, ECAPlusPlus_MS_TS, ECAPlusPlus_MS_TS_SC, C2f_Attention, Bottleneck_Attention, SimAM):
            c1, c2 = ch[f], args[0]
