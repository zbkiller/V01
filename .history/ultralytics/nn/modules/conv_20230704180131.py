...
########################## BasicRFB Attention https://cv2023.blog.csdn.net/article/details/131457230 ##################
...
class DSConv_Attention(_ConvNd):  #https://arxiv.org/pdf/1901.01928v1.pdf
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
        ...
        super(DSConv_Attention, self).__init__(
...
class DSConv2D(Conv):
    def __init__(self, inc, ouc, k=1, s=1, p=None, g=1, d=1, act=True):
        ...
        self.conv = DSConv_Attention(inc, ouc, k, s, p, g, d)
